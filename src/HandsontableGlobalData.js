        ...
        hotSettingsStr: `//<HotTable> settings object:
{
    ...
    componentDidMount = () => {
        window.data = getData(this.state.numRows);
    ...
    updateNumRows = (numRows) => {
        ...
        // stopwatch.start();
        window.data = getData(numRows, false);
    ...
    render() {
        ...
        return (
            <div>
                <p><span style={{ fontSize: '24px' }}>Handsontable </span><span style={{ color: 'gray' }}> rows as global objects array</span></p>
                <span >
...
export default HandsontableGlobalData;
